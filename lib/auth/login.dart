...
import 'package:animationsir/auth/Registration.dart';
    ...
    return Scaffold(
      body: Stack(
        children: [
          RegisterPage(),
          CachedNetworkImage(
            imageUrl: "https://cdn.pixabay.com/photo/2018/06/03/00/18/sea-3449509_960_720.jpg",
              ...
              children: [
                ...
                TextFormField(
                  ...
                  decoration: InputDecoration(
                    ...
                    icon: Icon(Icons.email,color: Colors.yellowAccent,size: 25,),
                ...
                TextFormField(
                  ...
                  decoration: InputDecoration(
                    hintText: 'Password',
                    hintStyle: TextStyle(color: Colors.white),
                    icon: Icon(Icons.remove_red_eye,color: Colors.yellowAccent,size: 25,),
                    enabledBorder: UnderlineInputBorder(
                      borderSide: BorderSide(color: Colors.grey),
                    ),
                    errorBorder: UnderlineInputBorder(
